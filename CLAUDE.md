...
- **Reynoso Inmobiliaria (Auren):** `reynoso-inmobiliaria-2026` — Automation & AI for real estate + urban developments (loteos) in Salta/NOA + Paraguay; 3 phases (omnichannel lead capture + smart assignment + auto-quoting in Odoo, lead reactivation + post-sale automation, web/portal sync + Paraguay funnel); Auren pricing (30% upfront U$D 10.500 + 3× U$D 8.166, 4 months) with optional unified website add-on +U$D 5.000. Seed: `npm run seed:reynoso-auren`
